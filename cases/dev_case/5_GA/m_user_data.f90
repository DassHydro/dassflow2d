MODULE m_user_data
   ...
   real(rp), parameter  ::  slope_rain = 0.0050_rp
   real(rp), parameter  ::  manning_coef  =  0.05_rp
...
CONTAINS
   ...
   !===================================================================================================================!
   ! greenampt_user_function
   !===================================================================================================================!
   
   real(rp) FUNCTION greenampt_psi_user( x , y )
   
      implicit none
	  
        real(rp), intent(in) :: x , y
	
      greenampt_psi_user = 0._rp
	  
    END FUNCTION greenampt_psi_user
 
    real(rp) FUNCTION greenampt_ks_user( x , y )
	
      implicit none
	  
        real(rp), intent(in) :: x , y
	
      greenampt_ks_user = 0._rp
	  
    END FUNCTION greenampt_ks_user
 
   real(rp) FUNCTION greenampt_theta_user( x , y )
   
      implicit none
	  
       real(rp), intent(in) :: x , y
	
      greenampt_theta_user = 0._rp
	  
    END FUNCTION greenampt_theta_user
   !===================================================================================================================!
   ! scs_lambda_user_function
   !===================================================================================================================!
    
	real(rp) FUNCTION scs_lambda_user( x , y )
	
      implicit none
	  
       real(rp), intent(in) :: x , y
  
      scs_lambda_user = 1._rp
	  
    END FUNCTION scs_lambda_user
   !===================================================================================================================!
   ! scs_cn_user_function
   !===================================================================================================================!
    real(rp) FUNCTION scs_cn_user( x , y )
