...
!=======================================================================
	real(rp) FUNCTION h_ex( x , y )
      ...
      h_ex  =  zs0_user( x , y ) - bathy_user( x , y )
...
!======================================================================================================================!
	...
	real(kind=rp) FUNCTION zs_exact( x , y , t )

      implicit none

		real(kind=rp), intent(in)  ::  x , y , t
! ZS exact needs to be the same as zs0_user for lake at rest test case
      zs_exact  =  2._rp
...
!======================================================================================================================!
	...
	real(kind=rp) FUNCTION u_exact( x , y , t )
...
!======================================================================================================================!
	...
	real(kind=rp) FUNCTION v_exact( x , y , t )
