...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 21 15:29:23 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 21 15:25:10 2023
...
mpl.rcParams['lines.markersize'] = 1e0
...
data["rain"][10:30]=0
ref = 30
for i in range(int((len(data["rain"])-ref)/12)):
    data["rain"][ref:ref+12] = oscilating_template
    ref = ref+12
...
for id_inflow in inflows.keys():
    ...
    plt.plot(np.arange(len(my_inflow["qsim"])),my_inflow["qsim"], label = f"id: {id_inflow} ")
    plt.legend()
plt.show()
plt.close()
...
plt.plot(np.arange(len(sum_rain))[100:115],
         sum_inflows[100:115] + sum_rain[100:115], 
         label = f"sum inflows+rain ", color = "red", marker="+", markersize=20)
plt.plot(np.arange(len(sum_inflows))[100:115],
         sum_inflows[100:115], color= 'blue' ,
         label = f"sum inflows ")
plt.plot(np.arange(len(my_inflow["qsim"]))[100:115],outflow[100:115], 
...
tokeep = np.where( (data["rain"] * 10 **-3 * 10**8 /dt_smash)[25:50] >outflow[25:50] )[0]
tokeep1 = tokeep[:6]
tokeep2 = tokeep[6:]
...
#        plt.fill_between(x =np.arange(len(my_inflow["qsim"]))[25:50], 
#                         y1 = inflow_cumsum[25:50], y2 =inflow_cumsum_minus1[25:50], label = id_inflow)
#        inflow_cumsum_minus1 = inflow_cumsum.copy()
#        
plt.fill_between(x =np.arange(len(my_inflow["qsim"]))[25:50], y1 =  sum_inflows[25:50], label = "sum inflows")
#
plt.fill_between(x =np.arange(len(my_inflow["qsim"]))[25:50], y1 = outflow[25:50], y2 = sum_inflows[25:50], label = "outflow")
#
plt.fill_between(x =np.arange(len(my_inflow["qsim"]))[25:50][tokeep1], 
                 y1 =  (data["rain"] * 10 **-3 * 10**8 /dt_smash)[25:50][tokeep1], 
                 y2 = outflow[25:50][tokeep1], label = "raw rainfall", color = "green")
plt.fill_between(x =np.arange(len(my_inflow["qsim"]))[25:50][tokeep2], 
                 y1 =  (data["rain"] * 10 **-3 * 10**8 /dt_smash)[25:50][tokeep2], 
                 y2 = outflow[25:50][tokeep2] , color = "green")
...
model_100.run()
#
#plt.plot(model_100.outputs.post.all_time, 
#         model_100.outputs.post.sum_mass_flux_inflow,
#         label = "inflows", color = "blue")
#plt.plot(model_100.outputs.post.all_time, 
#         model_100.outputs.post.sum_mass_flux_outflow,
#         label = "outflows", color = "red")
#plt.title("sum mass flux")
#plt.legend()
#plt.show()
...
#fig, ax1 = plt.subplots()
#
#ax1.plot(model_100.outputs.post.all_time, 
#         model_100.outputs.post.sum_q_inflow,
#         label = "inflows", color = "blue")
#plt.legend()
#plt.title("sum q")
#
#ax2 = ax1.twinx()
#ax2.plot(model_100.outputs.post.all_time, 
#         model_100.outputs.post.sum_q_outflow,
#         label = "outflows", color = "red")
#plt.legend()
#plt.show()
#plt.close()
#
#
#for i in range(model_100.outputs.result.h.shape[1]):
#    model_100.meshing.mesh_pyvista.plot( scalars = model_100.outputs.result.h[:,i])
#
#for i in range(model_100.outputs.result.zs.shape[1]):
#    model_100.meshing.mesh_pyvista.plot( scalars = model_100.outputs.result.zs[:,i])
#    
...
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "smash sum qin")
for my_scale in all_model.keys():    
...
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "smash qout")
for my_scale in all_model.keys():    
    plt.plot(all_model[my_scale].outputs.post.all_time, 
...
#plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows - outflow, label = "smash sum qin - outflow")
#for my_scale in all_model.keys():    
#    plt.plot(all_model[my_scale].outputs.post.all_time, 
#             all_model[my_scale].outputs.post.sum_mass_flux_inflow - 
#             all_model[my_scale].outputs.post.sum_mass_flux_outflow,
...
axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "smash ")
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "smash ")
...
fig, axs= plt.subplots(2)
axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600),  np.cumsum(sum_inflows), label = "smash ")
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600),  np.cumsum(outflow), label = "smash ")
...
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "sum inflows ")
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "sum outflow ")
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), 
         data["rain"] * 10 **-3 * 10**8 /3600, 
         label = "raw rainfall contributing to the outlet", linewidth=1)
plt.legend()
plt.xlabel("time [s]")
plt.ylabel("Water volume fluxes $[m^3/s]$")
plt.show()
...
axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "smash ")
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "smash ")
axs[2].plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "smash ")
...
axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "smash ", marker = ".", color = "black")
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "smash ", marker = ".",  color = "black")
axs[2].plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "smash ", marker = ".",  color = "black")
...
test = np.sum(model_100.outputs.post.sum_mass_flux_outflow, axis = 1)
index_to_store = []
for i in range(len(test)):
    if i >0 and i <len(test)-1:
        ...
        if value_i >= value_im1 and  value_i >= value_ip1:
            index_to_store.append(i)
            
            
time_to_show = [ model_100.outputs.post.all_time[i] for i in index_to_store ]  
        


plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), sum_inflows, label = "sum inflows ")
plt.plot(np.arange(0,nb_timestep_smash*3600, 3600), outflow, label = "sum outflow ")
plt.vlines(time_to_show, 
           ymin = 0,  
           ymax = max( max(outflow), max(sum_inflows)),
           color = "black")
...
for i in range(len(test)):
    if i >0 and i <len(test)-1:
        ...
        if value_i >= value_im1 and  value_i >= value_ip1:
            index_to_store.append(i)
time_to_show_1 = [ model_100.outputs.post.all_time[i] for i in index_to_store ]  
max_values_1 = [ model_100.outputs.post.sum_mass_flux_outflow[i][0] for i in index_to_store ]  

test = np.sum(model_100_3bc.outputs.post.sum_mass_flux_outflow, axis = 1)
index_to_store = []
for i in range(len(test)):
    if i >0 and i <len(test)-1:
        value_i = test[i]
        ...
        if value_i >= value_im1 and  value_i >= value_ip1:
            index_to_store.append(i)
time_to_show_3 = [ model_100_3bc.outputs.post.all_time[i] for i in index_to_store ]  
max_values_3 = [ model_100_3bc.outputs.post.sum_mass_flux_outflow[i][0] for i in index_to_store ]  
        



test = np.sum(model_100_nbc.outputs.post.sum_mass_flux_outflow, axis = 1)
index_to_store = []
for i in range(len(test)):
    if i >0 and i <len(test)-1:
        value_i = test[i]
        ...
        if value_i >= value_im1 and  value_i >= value_ip1:
            index_to_store.append(i)
time_to_show_n = [ model_100_nbc.outputs.post.all_time[i] for i in index_to_store ]  
max_values_n = [ model_100_nbc.outputs.post.sum_mass_flux_outflow[i][0] for i in index_to_store ]  
        

        

np.asanyarray((time_to_show_1, time_to_show_3, time_to_show_n) )


plt.plot(np.log(time_to_show_1), label = "1bc")
plt.plot(np.log(time_to_show_3), label =  "3bc")
plt.plot(np.log(time_to_show_n), label =  "nbc")
plt.legend()

time_to_show_1 = np.asanyarray(time_to_show_1)
time_to_show_3 = np.asanyarray(time_to_show_3)
time_to_show_n = np.asanyarray(time_to_show_n)


max_values_1 = np.asanyarray(max_values_1)
max_values_3 = np.asanyarray(max_values_3)
max_values_n = np.asanyarray(max_values_n)

time_to_show_n = time_to_show_n[1:]
max_values_n = max_values_n[1:]
#
#plt.plot((time_to_show_1-time_to_show_1), label = "1bc")
#plt.plot((time_to_show_3-time_to_show_1), label =  "3bc")
#plt.plot((time_to_show_n-time_to_show_1), label =  "nbc")
#plt.legend()
#
...
ax1.plot(model_100.outputs.post.all_time, 
         model_100.outputs.post.sum_mass_flux_outflow)
ax1.vlines(time_to_show_1, 
           ymin = 0,  
           ymax =150.,
           color = "black", linewidth = 0.5)
ax1.set_ylabel(r"Discharge $m^3/s$", fontsize=15)
#ax2=plt.subplot(4, 1,2)
ax2.plot(model_100_3bc.outputs.post.all_time, 
         model_100_3bc.outputs.post.sum_mass_flux_outflow)
ax2.vlines(time_to_show_3, 
           ymin = 0,  
           ymax =150.,
           color = "black", linewidth = 0.5)
ax2.set_ylabel(r"Discharge $m^3/s$", fontsize=15)

#ax3=plt.subplot(4, 1,3)
ax3.plot(model_100_nbc.outputs.post.all_time, 
         model_100_nbc.outputs.post.sum_mass_flux_outflow)
ax3.vlines(time_to_show_n, 
           ymin = 0,  
           ymax =150.,
           color = "black", linewidth = 0.5)
ax3.set_ylabel(r"Discharge $m^3/s$", fontsize=15)

ax4.plot(time_to_show_n , (time_to_show_1-time_to_show_1), label = "1bc")
ax4.plot(time_to_show_n, (time_to_show_3-time_to_show_1), label =  "3bc")
ax4.plot(time_to_show_n, (time_to_show_n-time_to_show_1), label =  "nbc")

ax4bis = ax4.twinx()
ax4bis.scatter(model_100.outputs.post.all_time[1000:] , 
           ( (model_100.outputs.post.sum_mass_flux_outflow-model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:],             
               label = "1bc", marker = "o", color = "red")
ax4bis.scatter(model_100.outputs.post.all_time[1000:], 
           ( (model_100_3bc.outputs.post.sum_mass_flux_outflow-model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:], 
            label =  "3bc", marker = "o", color = "blue")
ax4bis.scatter(model_100.outputs.post.all_time[1000:],
           ( ( model_100_nbc.outputs.post.sum_mass_flux_outflow- model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:], 
            label =  "nbc", marker = "o", color = "black")
ax4bis.set_ylabel( r" % Discharge  difference " +" \n with 1 bc geometry", fontsize=15)

ax4.set_ylabel( "peak time difference (s) \n with 1 bc geometry", fontsize=15)
ax4.set_xlabel( "Time (s)")

ax1.set_ylim(0,80)
ax2.set_ylim(0,80)
ax3.set_ylim(0,80)
ax4.legend(loc=8, ncol = 3)
...
fig, (ax1,ax4,ax5)= plt.subplots(3, 1,sharex=True)
#ax1=plt.subplot(4, 1,1)#
ax1.plot(model_100.outputs.post.all_time[40:], 
         model_100.outputs.post.sum_mass_flux_outflow[40:])
ax1.vlines(time_to_show_1, 
           ymin = 0,  
           ymax =150.,
           color = "black", linewidth = 0.5)
#ax2=plt.subplot(4, 1,2)
ax1.plot(model_100_3bc.outputs.post.all_time[40:], 
         model_100_3bc.outputs.post.sum_mass_flux_outflow[40:])
ax1.plot(model_100_nbc.outputs.post.all_time[40:], 
         model_100_nbc.outputs.post.sum_mass_flux_outflow[40:])
ax1.set_ylabel(r"Discharge $m^3/s$", fontsize=15)
ax4.plot(time_to_show_n , (time_to_show_1-time_to_show_1), label = "1bc")
ax4.plot(time_to_show_n, (time_to_show_3-time_to_show_1), label =  "3bc")
ax4.plot(time_to_show_n, (time_to_show_n-time_to_show_1), label =  "nbc")

ax5.scatter(model_100.outputs.post.all_time[1000:] , 
           ( (model_100.outputs.post.sum_mass_flux_outflow-model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:],             
               label = "1bc", marker = "o", color = "red")
ax5.scatter(model_100.outputs.post.all_time[1000:], 
           ( (model_100_3bc.outputs.post.sum_mass_flux_outflow-model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:], 
...
ax5.scatter(model_100.outputs.post.all_time[1000:],
           ( ( model_100_nbc.outputs.post.sum_mass_flux_outflow- model_100.outputs.post.sum_mass_flux_outflow)/model_100.outputs.post.sum_mass_flux_outflow)[1000:], 
            label =  "nbc", marker = "o", color = "black")
ax5.set_ylabel( r" % Discharge  difference " +" \n with 1 bc geometry", fontsize=15)
...
plt.xlabel( "Id of compared peak")
plt.legend()



# mean spead + distance à l'exhutoire de la bc la plus proche


t1 = time_to_show_1[2:8]
t3 = time_to_show_3[2:8]
tn = time_to_show_n[2:8]


plt.plot((t1-t1), label = "1bc")
plt.plot((t3-t1), label =  "3bc")
plt.plot((tn-t1), label =  "nbc")
plt.ylabel( "time difference (s)")
plt.legend()

print("mean delay between 1bc scenario and 3 bc:", np.mean(t3-t1), "(s)")
print("mean delay between 1bc scenario and n bc:", np.mean(tn-t1), "(s)")



###########################################################
# manual correction v2
#############################################################
# crio
...
#
# vitesse moyenne section 1/3 :
# vitesse moyenne section 1/n


#######################
# crop on wished timeline
########################
time_treshold= 100_000

fig, axs= plt.subplots(3)

axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   data["rain"][np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)]
   *10**-3* 10**4*10**4 /3600, 
   label = "smash ", marker = ".", color = "black", linewidth = 0.5)
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   data["rain"][np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)]
   *10**-3* 10**4*10**4 /3600, 
   label = "smash ", marker = ".", color = "black", linewidth = 0.5)
axs[2].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   data["rain"][np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)]
   *10**-3* 10**4*10**4 /3600, 
   label = "smash ", marker = ".", color = "black", linewidth = 0.5)
...
axs[0].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   sum_inflows[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   label = "smash ", marker = ".", color = "black")
axs[1].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   sum_inflows[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)], 
   label = "smash ", marker = ".",  color = "black")
axs[2].plot(np.arange(0,nb_timestep_smash*3600, 3600)[np.where(np.arange(0,nb_timestep_smash*3600, 3600)>time_treshold)],
...
axs[0].plot(model_100_nbc.outputs.post.all_time[np.where(model_100_nbc.outputs.post.all_time>time_treshold)], 
         np.sum(model_100_nbc.outputs.post.sum_mass_flux_inflow[np.where(model_100_nbc.outputs.post.all_time>time_treshold)], axis = 1),
         label = "100-nbc", color = "blue", marker = "+")
axs[0].plot(model_1000_nbc.outputs.post.all_time[np.where(model_1000_nbc.outputs.post.all_time>time_treshold)], 
         np.sum(model_1000_nbc.outputs.post.sum_mass_flux_inflow[np.where(model_1000_nbc.outputs.post.all_time>time_treshold)], axis = 1),
         label = "1000-nbc", color = "red")

axs[1].plot(model_100_3bc.outputs.post.all_time[np.where(model_1000_3bc.outputs.post.all_time>time_treshold)], 
         np.sum(model_100_3bc.outputs.post.sum_mass_flux_inflow[np.where(model_1000_3bc.outputs.post.all_time>time_treshold)], axis = 1),
         label = "100-3bc", color = "blue", marker = "+")

axs[1].plot(model_1000_3bc.outputs.post.all_time[np.where(model_1000_3bc.outputs.post.all_time>time_treshold)], 
         np.sum(model_1000_3bc.outputs.post.sum_mass_flux_inflow[np.where(model_1000_3bc.outputs.post.all_time>time_treshold)], axis = 1),
         label = "1000-3bc", color = "red")

axs[2].plot(model.outputs.post.all_time[np.where(model.outputs.post.all_time>time_treshold)], 
         np.sum(model.outputs.post.sum_mass_flux_inflow[np.where(model.outputs.post.all_time>time_treshold)], axis = 1),
         label = "100-1bc", color = "blue", marker = "+")
...
for id_inflow in inflows.keys():
    my_inflow = inflows[id_inflow]
    sum_inflows=sum_inflows+ my_inflow["qsim"]
    plt.plot(np.arange(len(my_inflow["qsim"]))[28:],my_inflow["qsim"][28:], label = f"id: {id_inflow} ")
    plt.legend()
plt.show()
plt.close()
