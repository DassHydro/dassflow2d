...
my_model.kernel.my_friction.manning[:] = 0. #<- value changed from target model
...
my_model.kernel.my_porosity.phi[:25] = 1
my_model.kernel.my_porosity.phi[25:75] = 0.75
my_model.kernel.my_porosity.phi[75:] = 1
