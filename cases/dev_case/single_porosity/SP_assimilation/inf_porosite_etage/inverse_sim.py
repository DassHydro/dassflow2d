...
input_params={ "mesh_name": mesh ,
              "ts": ts ,
               ...
               "w_tecplot":'0',
      		   "c_hydrograph":'0',
               "c_manning":'0', #<- we infer the (homogeneously distributed) friction
               "c_porosity":'1',
...
my_model.kernel.my_friction.manning[:] = 0.05 #<- value changed from target model
...
my_model.kernel.my_porosity.land[0:20] = 1
my_model.kernel.my_porosity.land[20:40] = 2
my_model.kernel.my_porosity.land[40:60] = 3
my_model.kernel.my_porosity.land[60:80] = 4
my_model.kernel.my_porosity.land[80:] = 5

my_model.kernel.my_porosity.phi[0] = 0.5
my_model.kernel.my_porosity.phi[1] = 0.5
my_model.kernel.my_porosity.phi[2] = 0.5
my_model.kernel.my_porosity.phi[3] = 0.5
my_model.kernel.my_porosity.phi[4] = 0.5
