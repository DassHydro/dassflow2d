...
#!/usr/bin/env python
import sys
sys.path.append( "/media/brisset/Windows/OpenTelemac/v6p2r1/pytel" ) # To adapt (get python parser of telemac)
from parsers.parserSELAFIN import SELAFIN,CONLIM
from utils.files import putFileContent
import numpy as np

# To change
mesh = SELAFIN('geocoraval2')                   # path of telemac mesh file
cond = CONLIM ('conlimrev2015')                 # path of boundary condition telemac mesh file
DassFlowMesh = open('garonne_jack_2.geo','w')   # path of new dassflow mesh file
# End to change
