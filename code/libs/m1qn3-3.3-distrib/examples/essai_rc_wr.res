 ...
 M1QN3 (Version 3.3, October 2009): entry point
     ...
     maximal number of iterations (niter):    10
 ...
 >>> m1qn3 (iteration 10): maximal number of iterations
 ...
 m1qn3: output mode is  4
     ...
     realized relative precision on g:  9.05D-05
     f             =  2.58275399D-02
     dfn-norm of g =  4.52618143D-01
 -------------------------------------------------------------------------------
 M1QN3 Copyright (C) 2008, J. Ch. Gilbert, Cl. Lemarechal.
 -------------------------------------------------------------------------------
 This program comes with ABSOLUTELY NO WARRANTY. This is free software, and you
 ...
 M1QN3 (Version 3.3, October 2009): entry point
     ...
     absolute precision on x (dxmin):          1.00D-10
     expected decrease for f (df1):            6.28D+03
     relative precision on g (epsg):           1.10D-01 (dfn-norm)
 ...
 m1qn3: iter 1, simul 1, f= 2.58275399D-02, h'(0)=-9.84247D-03
 ...
 m1qn3: stopping criterion on g:  7.52151D-01

 m1qn3: descent direction d: angle(-g,d) =   8.4 degrees

 -------------------------------------------------------------------------------

 m1qn3: iter 2, simul 2, f= 1.74136823D-02, h'(0)=-2.07702D-02
 ...
 m1qn3: stopping criterion on g:  2.62128D-01

 m1qn3: descent direction d: angle(-g,d) =   1.6 degrees

 -------------------------------------------------------------------------------

 m1qn3: iter 3, simul 3, f= 4.26478840D-03, h'(0)=-3.83800D-03
 ...
 m1qn3: stopping criterion on g:  1.22098D-01

 m1qn3: descent direction d: angle(-g,d) =   0.2 degrees

 -------------------------------------------------------------------------------

 m1qn3: iter 4, simul 4, f= 1.53846171D-03, h'(0)=-1.55780D-03
 ...
 m1qn3: stopping criterion on g:  5.08748D-02
 ...
 m1qn3: output mode is  1
     ...
     realized relative precision on g:  5.09D-02
     f             =  4.78867704D-04
