...
c
  ...
  900     format ("u1mt1: ntrav too large")
      ...
      reverse=1
 1000 continue
          call m1qn3 (simul_rc, euclid, ctonbe, ctcabe, n3, x, ff, g,
     &                dxmin, df1, epsrel, normtype, impres, io, imode,
     &                omode, iter, nsim, iz, trav, ntrav, reverse,
     &                indic, izs, rzs, dzs)
          if (reverse.lt.0) goto 1001
          call u1mt1s (indic, n3, x, ff, g, izs, rzs, dzs)
          goto 1000
 1001 continue
c
