...
&             xcenter-xsshape(1)%xleft))
          ...
          temp0 = temp**xsshape(1)%s
          IF (temp .LE. 0.0 .AND. (xsshape(1)%s .EQ. 0.0 .OR. xsshape(1)&
&             %s .NE. INT(xsshape(1)%s))) THEN
            temp_diff = 0.0_8
          ELSE IF (temp .LE. 0.0) THEN
            temp_diff = xsshape(1)%s*temp**(xsshape(1)%s-1)*(abs4_diff-&
&             temp*xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(&
&             1)%xleft)
          ELSE
            temp_diff = xsshape(1)%s*temp**(xsshape(1)%s-1)*(abs4_diff-&
&             temp*xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(&
&             1)%xleft) + temp0*LOG(temp)*xsshape_diff(1)%s
          END IF
...
&             xcenter-xsshape(1)%xleft))
          ...
          temp = temp0**xsshape(1)%s
          IF (temp0 .LE. 0.0 .AND. (xsshape(1)%s .EQ. 0.0 .OR. xsshape(1&
&             )%s .NE. INT(xsshape(1)%s))) THEN
            temp_diff0 = 0.0_8
          ELSE IF (temp0 .LE. 0.0) THEN
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs5_diff&
&             +temp0*xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape&
&             (1)%xcenter)
          ELSE
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs5_diff&
&             +temp0*xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape&
&             (1)%xcenter) + temp*LOG(temp0)*xsshape_diff(1)%s
          END IF
...
&             )%s .NE. INT(xsshape(1)%s))) THEN
            temp_diff0 = 0.0_8
          ELSE IF (temp0 .LE. 0.0) THEN
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs6_diff&
&             -temp0*xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-&
&             xsshape(1)%xleft)
          ELSE
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs6_diff&
&             -temp0*xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-&
&             xsshape(1)%xleft) + temp*LOG(temp0)*xsshape_diff(1)%s
          END IF
...
&             )%s .NE. INT(xsshape(1)%s))) THEN
            temp_diff0 = 0.0_8
          ELSE IF (temp0 .LE. 0.0) THEN
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs7_diff&
&             +temp0*xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape&
&             (1)%xcenter)
          ELSE
            temp_diff0 = xsshape(1)%s*temp0**(xsshape(1)%s-1)*(abs7_diff&
