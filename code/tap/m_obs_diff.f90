...
&                 INT(abs16))) THEN
              ...
              ELSE IF (temp0 .LE. 0.0) THEN
                temp_diff = abs16*temp0**(abs16-1)*(abs8_diff-temp0*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft)
              ELSE
                temp_diff = abs16*temp0**(abs16-1)*(abs8_diff-temp0*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft) + temp1*LOG(temp0)*abs16_diff
              END IF
...
&                 INT(abs17))) THEN
              ...
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs17*temp1**(abs17-1)*(abs9_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter)
              ELSE
                temp_diff0 = abs17*temp1**(abs17-1)*(abs9_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter) + temp0*LOG(temp1)*abs17_diff
              END IF
...
&                 INT(abs18))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs18*temp1**(abs18-1)*(abs10_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft)
              ELSE
                temp_diff0 = abs18*temp1**(abs18-1)*(abs10_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft) + temp0*LOG(temp1)*abs18_diff
              END IF
...
&                 INT(abs19))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs19*temp1**(abs19-1)*(abs11_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter)
              ELSE
                temp_diff0 = abs19*temp1**(abs19-1)*(abs11_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter) + temp0*LOG(temp1)*abs19_diff
              END IF
...
&                 INT(abs20))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs20*temp1**(abs20-1)*(abs12_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft)
              ELSE
                temp_diff0 = abs20*temp1**(abs20-1)*(abs12_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft) + temp0*LOG(temp1)*abs20_diff
              END IF
...
&                 INT(abs21))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs21*temp1**(abs21-1)*(abs13_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter)
              ELSE
                temp_diff0 = abs21*temp1**(abs21-1)*(abs13_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter) + temp0*LOG(temp1)*abs21_diff
              END IF
...
&                 INT(abs22))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs22*temp1**(abs22-1)*(abs14_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft)
              ELSE
                temp_diff0 = abs22*temp1**(abs22-1)*(abs14_diff-temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xcenter-xsshape(1&
&                 )%xleft) + temp0*LOG(temp1)*abs22_diff
              END IF
...
&                 INT(abs23))) THEN
                temp_diff0 = 0.0_8
              ELSE IF (temp1 .LE. 0.0) THEN
                temp_diff0 = abs23*temp1**(abs23-1)*(abs15_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter)
              ELSE
                temp_diff0 = abs23*temp1**(abs23-1)*(abs15_diff+temp1*&
&                 xsshape_diff(1)%xcenter)/(xsshape(1)%xright-xsshape(1)&
&                 %xcenter) + temp0*LOG(temp1)*abs23_diff
              END IF
