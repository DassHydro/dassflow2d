...
&           3))
    ...
    IF (branch .EQ. 0) THEN
      ...
      DO k=bc%nb_in,1,-1
        ...
        DO i=ad_to7,2,-1
          temp_back1 = 2*(bc%hyd(k)%q(i)-filtered(4))*cost_part_back(3)
          CALL POPREAL8(filtered(1))
          filtered_back(4) = filtered_back(4) + filtered_back(1) - &
&           temp_back1
          CALL POPREAL8(cost_part(3))
          bc_back%hyd(k)%q(i) = bc_back%hyd(k)%q(i) + temp_back1
      ...
      IF (branch .LT. 2) THEN
        IF (branch .EQ. 0) THEN
          ...
          DO ie=mesh%nc,1,-1
            ...
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(cost_part(2))
              temp_back1 = 2*(bathy_cell(ie)-slope_y(1)*mesh%cell(ie)%&
&               grav%y-slope_x(1)*mesh%cell(ie)%grav%x-xsshape(1)%topz-&
&               min6)*cost_part_back(2)
              bathy_cell_back(ie) = bathy_cell_back(ie) + temp_back1
              min6_back = -temp_back1
              CALL POPCONTROL1B(branch)
              IF (branch .EQ. 0) THEN
                CALL POPREAL8(min6)
                y6_back = min6_back
              ...
              IF (temp1 .LE. 0.0 .AND. (temp2 .EQ. 0.0 .OR. temp2 .NE. &
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs5*y6_back/(&
&                 xsshape(1)%xright-xsshape(1)%xcenter)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs5*y6_back
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs4*y5_back/(&
&                 xsshape(1)%xcenter-xsshape(1)%xleft)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs4*y5_back
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs7*y8_back/(&
&                 xsshape(1)%xright-xsshape(1)%xcenter)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs7*y8_back
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs6*y7_back/(&
&                 xsshape(1)%xcenter-xsshape(1)%xleft)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs6*y7_back
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs1*y2_back/(&
&                 xsshape(1)%xright-xsshape(1)%xcenter)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs1*y2_back
...
&               bathy_temp_back(ie)
              ...
              END IF
              temp0 = xsshape(1)%s
              temp1 = abs8/(xsshape(1)%xcenter-xsshape(1)%xleft)
              temp2 = temp1**temp0
              abs0_back = -((1-temp2)*y1_back)
              IF (temp1 .LE. 0.0 .AND. (temp0 .EQ. 0.0 .OR. temp0 .NE. &
&                 INT(temp0))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp0*temp1**(temp0-1)*abs0*y1_back/(&
&                 xsshape(1)%xcenter-xsshape(1)%xleft)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp2*LOG(temp1)*abs0*y1_back
              abs8_back = temp_back0
              xsshape_back(1)%xcenter = xsshape_back(1)%xcenter - temp1*&
&               temp_back0
              CALL POPCONTROL1B(branch)
              IF (branch .EQ. 0) THEN
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs3*y4_back/(&
&                 xsshape(1)%xright-xsshape(1)%xcenter)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs3*y4_back
...
&                 INT(temp2))) THEN
                temp_back0 = 0.0_8
              ELSE
                temp_back0 = temp2*temp1**(temp2-1)*abs2*y3_back/(&
&                 xsshape(1)%xcenter-xsshape(1)%xleft)
              END IF
              IF (.NOT.temp1 .LE. 0.0) xsshape_back(1)%s = xsshape_back(&
&                 1)%s + temp0*LOG(temp1)*abs2*y3_back
