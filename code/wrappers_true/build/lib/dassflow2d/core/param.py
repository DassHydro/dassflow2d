...
#            - self.manning_beta.patch_value(size=nb_patch)
        ...
        def __force_format_manning__(self):
            ...
            """
            self.manning["mesh_correspondance"]=np.array(self.manning["mesh_correspondance"], ndmin=1)
            self.manning["patch_correspondance"]=np.array(self.manning["patch_correspondance"], ndmin=1)
            self.manning["patch_value"]=np.array(self.manning["patch_value"], ndmin=1)
...
#            # todo mesh manning_beta value
        ...
        def set_manning(self):
            ...
            dassflow2d.wrapping.m_model.manning[...]  = self.manning["patch_value"]
            
            # set land use correspondance in fortran kernel
            dassflow2d.wrapping.m_model.land[...] = self.manning["mesh_correspondance"]
