...
class vec2d(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _wrapping.f90wrap_m_linear_algebra__vec2d_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__vec2d_finalise(this=self._handle)
...
class vec3d(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_linear_algebra__vec3d_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__vec3d_finalise(this=self._handle)
...
class tens2d(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_linear_algebra__tens2d_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__tens2d_finalise(this=self._handle)
...
class tens3d(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_linear_algebra__tens3d_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__tens3d_finalise(this=self._handle)
...
class sys_lin_full(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_linear_algebra__sys_lin_full_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__sys_lin_full_finalise(this=self._handle)
...
class sys_lin_sparse(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_linear_algebra__sys_lin_sparse_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_linear_algebra__sys_lin_sparse_finalise(this=self._handle)
