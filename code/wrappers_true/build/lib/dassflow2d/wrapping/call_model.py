...
Defined at call_run_model.f90 lines 1-874
...
class Model(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _wrapping.f90wrap_call_model__model_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_call_model__model_finalise(mdl=self._handle)
...
def init_solver(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_solver(mdl=self._handle)
...
def init_friction(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_friction(mdl=self._handle)
...
def init_infiltration(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_infiltration(mdl=self._handle)
...
def init_porosity(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_porosity(mdl=self._handle)
...
def init_phys_desc(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_phys_desc(mdl=self._handle)
...
def init_bc(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_bc(mdl=self._handle)
...
def init_fortran(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_fortran(mdl=self._handle)
...
def init_back(self):
    ...
    """
    _wrapping.f90wrap_call_model__init_back(mdl=self._handle)
...
def run(self, arg=None):
    ...
    """
    _wrapping.f90wrap_call_model__run(mdl=self._handle, arg=arg)
...
def clean_model(self):
    ...
    Brief:
    """
    _wrapping.f90wrap_call_model__clean_model(mdl=self._handle)
...
def output_gnu(self, dof, filename):
    ...
    """
    _wrapping.f90wrap_call_model__output_gnu(mdl=self._handle, dof=dof._handle, \
        filename=filename)
...
def output_vtk(self, dof, filename):
    ...
    """
    _wrapping.f90wrap_call_model__output_vtk(mdl=self._handle, dof=dof._handle, \
        filename=filename)
...
def output_tec(self, dof, filename):
    ...
    """
    _wrapping.f90wrap_call_model__output_tec(mdl=self._handle, dof=dof._handle, \
        filename=filename)
...
def friction_initialise(cls, mesh):
    ...
    result = _wrapping.f90wrap_call_model__friction_initialise(mesh=mesh._handle)
...
def __del__(self):
    ...
    """
    if self._alloc:
        _wrapping.f90wrap_call_model__friction_finalise(my_friction=self._handle)
...
def infiltration_initialise(cls, mesh):
    ...
    f90wrap.runtime.FortranDerivedType.__init__(bare_class)
    result = \
        _wrapping.f90wrap_call_model__infiltration_initialise(mesh=mesh._handle)
    bare_class._handle = result[0] if isinstance(result, tuple) else result
    return bare_class
...
def __del__(self):
    ...
    """
    if self._alloc:
        _wrapping.f90wrap_call_model__infiltration_finalise(my_infiltration=self._handle)
...
def porosity_initialise(cls, mesh):
    ...
    Defined at call_run_model.f90 lines 413-429
    ...
    bare_class = cls.__new__(cls)
    f90wrap.runtime.FortranDerivedType.__init__(bare_class)
    result = _wrapping.f90wrap_call_model__porosity_initialise(mesh=mesh._handle)
    bare_class._handle = result[0] if isinstance(result, tuple) else result
    return bare_class
...
def __del__(self):
    ...
    Defined at call_run_model.f90 lines 431-442
    ...
    """
    if self._alloc:
        _wrapping.f90wrap_call_model__porosity_finalise(my_porosity=self._handle)
...
def phys_desc_initialise(cls, mesh):
    ...
    Defined at call_run_model.f90 lines 444-471
    ...
    bare_class = cls.__new__(cls)
    f90wrap.runtime.FortranDerivedType.__init__(bare_class)
    result = _wrapping.f90wrap_call_model__phys_desc_initialise(mesh=mesh._handle)
    bare_class._handle = result[0] if isinstance(result, tuple) else result
    return bare_class
...
def __del__(self):
    ...
    Defined at call_run_model.f90 lines 473-482
    ...
    """
    if self._alloc:
        _wrapping.f90wrap_call_model__phys_desc_finalise(my_phys_desc=self._handle)
...
def __init__(self, mesh, handle=None):
    ...
    Defined at call_run_model.f90 lines 484-510
    ...
    """
    f90wrap.runtime.FortranDerivedType.__init__(self)
    result = _wrapping.f90wrap_call_model__bc_initialise(mesh=mesh._handle)
    self._handle = result[0] if isinstance(result, tuple) else result
...
def __del__(self):
    ...
    Defined at call_run_model.f90 lines 512-517
    ...
    """
    if self._alloc:
        _wrapping.f90wrap_call_model__bc_finalise(my_bc=self._handle)
...
def func(self, ctrl_in, grad_func):
    ...
    Defined at call_run_model.f90 lines 519-547
    ...
    """
    cost_func = _wrapping.f90wrap_call_model__func(mdl=self._handle, \
        ctrl_in=ctrl_in, grad_func=grad_func)
    return cost_func
...
def write_land_uses():
    ...
    Defined at call_run_model.f90 lines 690-706
    
    
    =================================================================================================
    "
    """
    _wrapping.f90wrap_call_model__write_land_uses()
...
def write_bc():
    ...
    Defined at call_run_model.f90 lines 713-788
    ...
    ===================================================================================================================
    """
    _wrapping.f90wrap_call_model__write_bc()
...
def write_hydrograph():
    ...
    Defined at call_run_model.f90 lines 790-833
    ...
    ===================================================================================================================
    """
    _wrapping.f90wrap_call_model__write_hydrograph()
...
def boundaries_copy(self):
    ...
    Defined at call_run_model.f90 lines 835-839
    ...
    """
    o = _wrapping.f90wrap_call_model__boundaries_copy(i=self._handle)
...
def dof_copy(self):
    ...
    Defined at call_run_model.f90 lines 844-848
    ...
    """
    o = _wrapping.f90wrap_call_model__dof_copy(i=self._handle)
...
def mesh_copy(self):
    ...
    Defined at call_run_model.f90 lines 853-857
    ...
    """
    o = _wrapping.f90wrap_call_model__mesh_copy(i=self._handle)
...
def reallocate_manning(new_size):
    ...
    Defined at call_run_model.f90 lines 862-874
    ...
    """
    _wrapping.f90wrap_call_model__reallocate_manning(new_size=new_size)
