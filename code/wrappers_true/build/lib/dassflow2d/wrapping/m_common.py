...
Defined at m_common.f90 lines 1-654
...
class weights(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_common.f90 lines 91-92
    ...
    def __init__(self, handle=None):
        ...
        result = _wrapping.f90wrap_m_common__weights_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_common__weights_finalise(this=self._handle)
    ...
    def weights(self):
        ...
        Defined at m_common.f90 line 92
...
def test_dt_nearest(dt_to_test):
    ...
    Defined at m_common.f90 lines 101-122
    
    Parameters
    ----------
    dt_to_test : float, [in] Time step to test.
    
    Returns
    -------
    test_dt_nearest : bool, Boolean returned
    ...
    _COMMENT================================================================================================================
    _COMMENT
    Details: If the dt_to_test is the more close to time step of the dt possible, \
        this function return true,
    """
    test_dt_nearest = \
        _wrapping.f90wrap_m_common__test_dt_nearest(dt_to_test=dt_to_test)
...
def test_dt_just_after(dt_to_test):
    ...
    Defined at m_common.f90 lines 129-150
    ...
    Returns
    -------
    test_dt_just_after : bool, Boolean returned
    ...
    _COMMENT================================================================================================================
    _COMMENT
    Details: If the dt_to_test is the dt just after the actual dt, this function \
        return true, else return false.
    """
    test_dt_just_after = \
        _wrapping.f90wrap_m_common__test_dt_just_after(dt_to_test=dt_to_test)
...
def reading_args():
    ...
    Defined at m_common.f90 lines 154-166
    
    
    """
    _wrapping.f90wrap_m_common__reading_args()
...
def machine_number_limits():
    ...
    Defined at m_common.f90 lines 319-350
    
    
    ================================================================================================================
     Machine zero
    ================================================================================================================
    Details: Compute the value of the machine infinities, machine zeo and machine \
        overflow/underflow.
    """
    _wrapping.f90wrap_m_common__machine_number_limits()
...
def swap_r(a, b):
    ...
    Parameters
    ----------
    a : float, [inout] real variable to swap.
    b : float, [inout] real variable to swap.
    
    Details: Swap two real variables.
    """
    _wrapping.f90wrap_m_common__swap_r(a=a, b=b)
...
def swap_i(a, b):
    ...
    Defined at m_common.f90 lines 368-372
    
    Parameters
    ----------
    a : int, [inout] integer variable to swap.
    b : int, [inout] integer variable to swap.
    
    Details: Swap two integer variables.
    """
    _wrapping.f90wrap_m_common__swap_i(a=a, b=b)
...
def swap_vec_r(vec, swap):
    ...
    Defined at m_common.f90 lines 379-389
    
    Parameters
    ----------
    vec : float array, [inout] real vector variable to swap.
    swap : int array, [inout] real vector variable to swap.
    
    Details: Swap two real vectors.
    """
    _wrapping.f90wrap_m_common__swap_vec_r(vec=vec, swap=swap)
...
def swap_vec_i(vec, swap):
    ...
    Defined at m_common.f90 lines 396-406
    
    Parameters
    ----------
    vec : int array, [inout] integer vector variable to swap.
    swap : int array, [inout] integer vector variable to swap.
    
    Details: Swap two integer vectors.
    """
    _wrapping.f90wrap_m_common__swap_vec_i(vec=vec, swap=swap)
...
def div_by_except_0(a, b):
    ...
    Defined at m_common.f90 lines 414-421
    
    Parameters
    ----------
    a : float, [in] numerator.
    b : float, [in] denominator.
    
    Returns
    -------
    div_by_except_0 : float, results of a/b
    
    Details: This function does the division between two real, if the denominator is \
        equal to 0 the result is 0.
    """
    div_by_except_0 = _wrapping.f90wrap_m_common__div_by_except_0(a=a, b=b)
...
def i4col_sort_a(m, n, a):
    ...
    Defined at m_common.f90 lines 432-460
    
    Parameters
    ----------
    m : int, [in] length of x.
    n : int, [in] lenght of y.
    a : int array, [inout] maxtrix x,y.
    
    ================================================================================================================
     Initialize.
    ================================================================================================================
    Details: In lexicographic order, the statement "X < Y", applied to two real \
        vectors X and Y of length M,
    Author: John Burkardt(GNU LGPL license)
    """
    _wrapping.f90wrap_m_common__i4col_sort_a(m=m, n=n, a=a)
...
def sort_heap_external(n, indx, i, j, isgn):
    ...
    Defined at m_common.f90 lines 473-567
    
    Parameters
    ----------
    n : int, [in] integer.
    indx : int, [inout] integer.
    i : int, [out] integer.
    j : int, [out] integer.
    isgn : int, [in] integer.
    ...
    ================================================================================================================
    Details: The actual list of data is not passed to the routine. Hence this \
        routine may be used to sort integer
    Author: John Burkardt(GNU LGPL license)
    """
    _wrapping.f90wrap_m_common__sort_heap_external(n=n, indx=indx, i=i, j=j, \
        isgn=isgn)
...
def i4col_swap(m, n, a, i, j):
    ...
    Defined at m_common.f90 lines 577-586
    
    Parameters
    ----------
    m : int, [in] integer.
    n : int, [in] integer.
    a : int array, [inout] integer.
    i : int, [in] integer.
    j : int, [in] integer.
    
    Author: John Burkardt(GNU LGPL license)
    """
    _wrapping.f90wrap_m_common__i4col_swap(m=m, n=n, a=a, i=i, j=j)
...
def i4col_compare(m, n, a, i, j):
    ...
    Defined at m_common.f90 lines 597-615
    
    Parameters
    ----------
    m : int, [in] integer.
    n : int, [in] integer.
    a : int array, [in] integer.
    i : int, [in] integer.
    j : int, [in] integer.
    
    Returns
    -------
    isgn : int, [out] integer.
    
    Author: John Burkardt(GNU LGPL license)
    """
    isgn = _wrapping.f90wrap_m_common__i4col_compare(m=m, n=n, a=a, i=i, j=j)
    return isgn
...
def file_name_ext(file_name, typ):
    ...
    Defined at m_common.f90 lines 623-635
    
    Parameters
    ----------
    file_name : str, [in] Name of the file.
    typ : str, [in] Type of the file.
    ...
    Details: From a file name and a extension('tecplot', 'gnuplot', ...) complete \
        file name.
    """
    file_name_res = _wrapping.f90wrap_m_common__file_name_ext(file_name=file_name, \
        typ=typ)
...
def count_lines(file_name):
    ...
    Defined at m_common.f90 lines 641-654
    ...
    """
    nb_lines = _wrapping.f90wrap_m_common__count_lines(file_name=file_name)
    return nb_lines
...
def set_do_warmup(do_warmup):
    _wrapping.f90wrap_m_common__set__do_warmup(do_warmup)
...
def set_use_zobs(use_zobs):
    _wrapping.f90wrap_m_common__set__use_zobs(use_zobs)
...
def set_use_hobs(use_hobs):
    _wrapping.f90wrap_m_common__set__use_hobs(use_hobs)
...
def set_use_uvobs(use_uvobs):
    _wrapping.f90wrap_m_common__set__use_uvobs(use_uvobs)
...
def set_use_huvobs(use_huvobs):
    _wrapping.f90wrap_m_common__set__use_huvobs(use_huvobs)
...
def set_use_qobs(use_qobs):
    _wrapping.f90wrap_m_common__set__use_qobs(use_qobs)

def get_use_qobs_gr4():
    """
...
def set_use_qobs_gr4(use_qobs_gr4):
    _wrapping.f90wrap_m_common__set__use_qobs_gr4(use_qobs_gr4)
...
def set_use_nse(use_nse):
    _wrapping.f90wrap_m_common__set__use_nse(use_nse)
...
def set_use_xsshp(use_xsshp):
    _wrapping.f90wrap_m_common__set__use_xsshp(use_xsshp)

def get_xsshp_along_x():
    """
...
def set_xsshp_along_x(xsshp_along_x):
    _wrapping.f90wrap_m_common__set__xsshp_along_x(xsshp_along_x)

def get_xsshp_along_y():
    """
...
def set_xsshp_along_y(xsshp_along_y):
    _wrapping.f90wrap_m_common__set__xsshp_along_y(xsshp_along_y)
...
def set_array_is_file_open(is_file_open):
    globals()['is_file_open'][...] = is_file_open
...
def get_d1p3():
    ...
    Defined at m_common.f90 line 80
...
def get_d4p3():
    ...
    Defined at m_common.f90 line 82
...
def get_d5p3():
    ...
    Defined at m_common.f90 line 83
...
def get_d7p3():
    ...
    Defined at m_common.f90 line 84
...
def get_d8p3():
    ...
    Defined at m_common.f90 line 85
...
def get_d10p3():
    ...
    Defined at m_common.f90 line 86
...
def get_d3p2():
    ...
    Defined at m_common.f90 line 87
...
def get_d3p5():
    ...
    Defined at m_common.f90 line 88
...
def get_d3p8():
    ...
    Defined at m_common.f90 line 89
...
def get_pi():
    ...
    Defined at m_common.f90 line 90
