...
class Boundary(object):
    ...
    def plot(self, what = "values",title_plot = "boundaries localisation", save_plot= False, filename="boundaries_location"):
        """
        ...
        if what == 'meshing' :
            ...
            conditions = [        "wall" , "discharg1", "discharg2", "neumann","transm",  "ratcurve"    ,"hpresc" ,"zpresc", "internal_1D", "internal_2D"]
            colors =     ["black","grey", "red"      , "orange"   , "yellow" , "yellow", "yellow"      ,"#779231", "#329C46", "blue","green" ]
