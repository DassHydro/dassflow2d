...
Defined at m_sw_mono.f90 lines 1-849
...
import logging
import numpy
from wrapping.m_linear_algebra import vec2d
...
class unk(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, mesh, handle=None):
        ...
        Defined at m_sw_mono.f90 lines 790-814
        ...
        result = _wrapping.f90wrap_m_model__unk_initialise(mesh=mesh._handle)
    ...
    def __del__(self):
        ...
        Defined at m_sw_mono.f90 lines 817-831
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__unk_finalise(dof=self._handle)
...
class xsshp(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__xsshp_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__xsshp_finalise(this=self._handle)
...
class greenampt(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__greenampt_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__greenampt_finalise(this=self._handle)
...
class scs_cn(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__scs_cn_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__scs_cn_finalise(this=self._handle)
...
class infiltration_data(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__infiltration_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__infiltration_data_finalise(this=self._handle)
...
class friction_data(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__friction_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__friction_data_finalise(this=self._handle)
...
class porosity_data(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__porosity_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__porosity_data_finalise(this=self._handle)
...
class param_model(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 109-111
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__param_model_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__param_model_finalise(this=self._handle)
...
class gr4(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 118-123
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__gr4_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__gr4_finalise(this=self._handle)
...
class hydrograph(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__hydrograph_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__hydrograph_finalise(this=self._handle)
...
class hpresc(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 130-132
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__hpresc_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__hpresc_finalise(this=self._handle)
...
class zspresc(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 134-136
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__zspresc_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__zspresc_finalise(this=self._handle)
...
class ratcurve(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 139-142
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__ratcurve_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__ratcurve_finalise(this=self._handle)
...
class rain(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 144-152
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__rain_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__rain_finalise(this=self._handle)
...
class bcs(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 155-168
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__bcs_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__bcs_finalise(this=self._handle)
...
class station_obs(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 176-185
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__station_obs_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__station_obs_finalise(this=self._handle)
...
class section_obs(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 188-192
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__section_obs_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__section_obs_finalise(this=self._handle)
...
class station_obsQ(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 194-204
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__station_obsq_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__station_obsq_finalise(this=self._handle)
...
class soil_data(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 215-220
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__soil_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__soil_data_finalise(this=self._handle)
...
class ptf_data(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 222-223
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__ptf_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__ptf_data_finalise(this=self._handle)
...
class surface_data(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 225-227
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__surface_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__surface_data_finalise(this=self._handle)
...
class structure_data(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 229-235
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__structure_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__structure_data_finalise(this=self._handle)
...
class input_data(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 237-249
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__input_data_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__input_data_finalise(this=self._handle)
...
class Input_Param(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_sw_mono.f90 lines 404-498
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_model__input_param_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_model__input_param_finalise(this=self._handle)
    ...
    def eps_ptf(self):
        ...
        Defined at m_sw_mono.f90 line 490
    ...
    def regul_ratcurve(self):
        ...
        Defined at m_sw_mono.f90 line 498
...
def default_values():
    ...
    Defined at m_sw_mono.f90 lines 502-587
    
    
    Details: h,u,v are the unknowns of the model
    """
    _wrapping.f90wrap_m_model__default_values()
...
def alloc_dof(self):
    ...
    Defined at m_sw_mono.f90 lines 589-641
    ...
    _COMMENT ============================= ===================================
    """
    dof = _wrapping.f90wrap_m_model__alloc_dof(mesh=self._handle)
...
def dealloc_dof(self):
    ...
    Defined at m_sw_mono.f90 lines 643-654
    ...
    """
    _wrapping.f90wrap_m_model__dealloc_dof(dof=self._handle)
...
def dealloc_model():
    ...
    Defined at m_sw_mono.f90 lines 656-713
    ...
    ------------------------------------------------
     BC
    """
    _wrapping.f90wrap_m_model__dealloc_model()
...
def spatial_index_fromxy(self, xmin, xmax, ymin, ymax, spatial_index):
    ...
    Defined at m_sw_mono.f90 lines 840-848
    ...
    """
    _wrapping.f90wrap_m_model__spatial_index_fromxy(mesh=self._handle, xmin=xmin, \
        xmax=xmax, ymin=ymin, ymax=ymax, spatial_index=spatial_index)
...
def get_array_porosity_history():
    """
    Element porosity_history ftype=real(rp) pytype=float
    
    
    Defined at m_sw_mono.f90 line 105
    
    """
    global porosity_history
    array_ndim, array_type, array_shape, array_handle = \
        _wrapping.f90wrap_m_model__array__porosity_history(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        porosity_history = _arrays[array_handle]
    else:
        porosity_history = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _wrapping.f90wrap_m_model__array__porosity_history)
        _arrays[array_handle] = porosity_history
    return porosity_history

def set_array_porosity_history(porosity_history):
    globals()['porosity_history'][...] = porosity_history
...
def get_phys_desc():
    ...
    Defined at m_sw_mono.f90 line 251
...
_array_initialisers = [get_array_bathy_node, get_array_bathy_cell, \
    ...
    get_array_slope_y, get_array_slope_x, get_array_porosity_history]
_dt_array_initialisers = []
