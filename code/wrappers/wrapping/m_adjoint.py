...
Defined at m_adjoint.f90 lines 1-1199
...
def model_direct(self, dof0, dof):
    ...
    Defined at m_adjoint.f90 lines 34-49
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__model_direct(mesh=self._handle, dof0=dof0._handle, \
        dof=dof._handle)
...
def model_direct_perturb(self, dof0, dof):
    ...
    Defined at m_adjoint.f90 lines 51-68
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__model_direct_perturb(mesh=self._handle, \
        dof0=dof0._handle, dof=dof._handle)
...
def adjoint_model(self, dof0, dof):
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__adjoint_model(mesh=self._handle, dof0=dof0._handle, \
        dof=dof._handle)
...
def write_control(self, mesh):
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__write_control(dof0=self._handle, mesh=mesh._handle)
...
def write_control_back(self, mesh):
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__write_control_back(dof0=self._handle, \
        mesh=mesh._handle)
...
def read_control(self, mesh):
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__read_control(dof0=self._handle, mesh=mesh._handle)
...
def output_control(self, mesh):
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__output_control(dof0=self._handle, \
        mesh=mesh._handle)
...
def output_control_back(self):
    ...
    Defined at m_adjoint.f90 lines 1124-1199
    ...
    ================================================================================================================
    """
    _wrapping.f90wrap_m_adjoint__output_control_back(mesh=self._handle)
...
def set_array_control_back(control_back):
    globals()['control_back'][...] = control_back
...
def set_array_control_diff(control_diff):
    globals()['control_diff'][...] = control_diff
...
def set_array_control_perturb(control_perturb):
    globals()['control_perturb'][...] = control_perturb
...
def set_array_control_lbound(control_lbound):
    globals()['control_lbound'][...] = control_lbound
...
def set_array_control_ubound(control_ubound):
    globals()['control_ubound'][...] = control_ubound
...
def set_array_dim_vars_in_control(dim_vars_in_control):
    globals()['dim_vars_in_control'][...] = dim_vars_in_control
...
def get_dim_all():
    ...
    Defined at m_adjoint.f90 line 30
...
def get_array_bathy_cell_copy():
    ...
    Defined at m_adjoint.f90 line 32
...
def set_array_bathy_cell_copy(bathy_cell_copy):
    globals()['bathy_cell_copy'][...] = bathy_cell_copy
