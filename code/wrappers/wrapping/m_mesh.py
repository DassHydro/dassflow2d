...
Defined at m_mesh.f90 lines 1-387
...
class NodeType(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, dim1, dim2, handle=None):
        ...
        Defined at m_mesh.f90 lines 351-361
        ...
        result = _wrapping.f90wrap_m_mesh__nodetype_initialise(dim1=dim1, dim2=dim2)
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__nodetype_finalise(this=self._handle)
...
class NodeTypeLim(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, ind, group, handle=None):
        ...
        Defined at m_mesh.f90 lines 364-371
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__nodetypelim_initialise(ind=ind, group=group)
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__nodetypelim_finalise(this=self._handle)
...
class CellType(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 33-44
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__celltype_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__celltype_finalise(this=self._handle)
    ...
    def ind(self):
        ...
        """
        return _wrapping.f90wrap_celltype__get__ind(self._handle)
    
    @ind.setter
    def ind(self, ind):
        _wrapping.f90wrap_celltype__set__ind(self._handle, ind)
...
class CellTypeLim(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 50-55
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__celltypelim_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__celltypelim_finalise(this=self._handle)
...
class EdgeType(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 61-73
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__edgetype_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__edgetype_finalise(this=self._handle)
...
class EdgeTypeLim(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 79-83
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__edgetypelim_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__edgetypelim_finalise(this=self._handle)
...
class msh(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 89-105
    ...
    def __init__(self, handle=None):
        ...
        Defined at m_mesh.f90 lines 374-377
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__msh_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        Defined at m_mesh.f90 lines 380-387
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__msh_finalise(mesh=self._handle)
    ...
    def surf(self):
        ...
        Defined at m_mesh.f90 line 104
    ...
    def swap_index(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _wrapping.f90wrap_msh__array__swap_index(self._handle)
        if array_handle in self._arrays:
            swap_index = self._arrays[array_handle]
        else:
            swap_index = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _wrapping.f90wrap_msh__array__swap_index)
            self._arrays[array_handle] = swap_index
        return swap_index
    ...
    def inv_swap_index(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _wrapping.f90wrap_msh__array__inv_swap_index(self._handle)
        if array_handle in self._arrays:
            inv_swap_index = self._arrays[array_handle]
        else:
            inv_swap_index = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _wrapping.f90wrap_msh__array__inv_swap_index)
            self._arrays[array_handle] = inv_swap_index
        return inv_swap_index
    
    @inv_swap_index.setter
    def inv_swap_index(self, inv_swap_index):
        self.inv_swap_index[...] = inv_swap_index
    ...
    def __str__(self):
        ...
        ret.append(repr(self.surf))
        ret.append(',\n    swap_index : ')
        ret.append(repr(self.swap_index))
        ret.append(',\n    inv_swap_index : ')
        ret.append(repr(self.inv_swap_index))
        ret.append('}')
        return ''.join(ret)
...
class point_in_mesh(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at m_mesh.f90 lines 112-114
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _wrapping.f90wrap_m_mesh__point_in_mesh_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _wrapping.f90wrap_m_mesh__point_in_mesh_finalise(this=self._handle)
    ...
    def coord(self):
        ...
        Defined at m_mesh.f90 line 113
...
def display_mesh_cell(self):
    ...
    Defined at m_mesh.f90 lines 127-135
    ...
    """
    _wrapping.f90wrap_m_mesh__display_mesh_cell(mesh=self._handle)
...
def calc_cells_connectivity(self):
    ...
    Defined at m_mesh.f90 lines 291-348
    ...
    """
    _wrapping.f90wrap_m_mesh__calc_cells_connectivity(mesh=self._handle)
