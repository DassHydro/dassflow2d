...
subroutine f90wrap_model__get__my_porosity(this, f90wrap_my_porosity)
    use call_model, only: model
    ...
    integer, intent(in)   :: this(2)
    type(Model_ptr_type) :: this_ptr
    integer, intent(out) :: f90wrap_my_porosity(2)
    type(porosity_data_ptr_type) :: my_porosity_ptr
    
    this_ptr = transfer(this, this_ptr)
    my_porosity_ptr%p => this_ptr%p%my_porosity
    f90wrap_my_porosity = transfer(my_porosity_ptr,f90wrap_my_porosity)
end subroutine f90wrap_model__get__my_porosity

subroutine f90wrap_model__set__my_porosity(this, f90wrap_my_porosity)
    use call_model, only: model
    use m_model, only: porosity_data
    implicit none
    type model_ptr_type
    ...
    integer, intent(in)   :: this(2)
    type(Model_ptr_type) :: this_ptr
    integer, intent(in) :: f90wrap_my_porosity(2)
    type(porosity_data_ptr_type) :: my_porosity_ptr
    
    this_ptr = transfer(this, this_ptr)
    my_porosity_ptr = transfer(f90wrap_my_porosity,my_porosity_ptr)
    this_ptr%p%my_porosity = my_porosity_ptr%p
end subroutine f90wrap_model__set__my_porosity
...
subroutine f90wrap_model__get__my_bc(this, f90wrap_my_bc)
    use call_model, only: model
    ...
    integer, intent(in)   :: this(2)
    type(Model_ptr_type) :: this_ptr
    integer, intent(out) :: f90wrap_my_bc(2)
    type(bcs_ptr_type) :: my_bc_ptr
    
    this_ptr = transfer(this, this_ptr)
    my_bc_ptr%p => this_ptr%p%my_bc
    f90wrap_my_bc = transfer(my_bc_ptr,f90wrap_my_bc)
end subroutine f90wrap_model__get__my_bc

subroutine f90wrap_model__set__my_bc(this, f90wrap_my_bc)
    use call_model, only: model
    use m_model, only: bcs
    implicit none
    type model_ptr_type
    ...
    integer, intent(in)   :: this(2)
    type(Model_ptr_type) :: this_ptr
    integer, intent(in) :: f90wrap_my_bc(2)
    type(bcs_ptr_type) :: my_bc_ptr
    
    this_ptr = transfer(this, this_ptr)
    my_bc_ptr = transfer(f90wrap_my_bc,my_bc_ptr)
    this_ptr%p%my_bc = my_bc_ptr%p
end subroutine f90wrap_model__set__my_bc

subroutine f90wrap_call_model__model_initialise(mdl)
...
subroutine f90wrap_call_model__init_infiltration(mdl)
    ...
    integer, intent(in), dimension(2) :: mdl
    mdl_ptr = transfer(mdl, mdl_ptr)
    call init_infiltration(mdl=mdl_ptr%p)
...
subroutine f90wrap_call_model__init_porosity(mdl)
    ...
    integer, intent(in), dimension(2) :: mdl
    mdl_ptr = transfer(mdl, mdl_ptr)
    call init_porosity(mdl=mdl_ptr%p)
end subroutine f90wrap_call_model__init_porosity

subroutine f90wrap_call_model__init_phys_desc(mdl)
    ...
    integer, intent(in), dimension(2) :: mdl
    mdl_ptr = transfer(mdl, mdl_ptr)
    call init_phys_desc(mdl=mdl_ptr%p)
...
subroutine f90wrap_call_model__init_bc(mdl)
    ...
    integer, intent(in), dimension(2) :: mdl
    mdl_ptr = transfer(mdl, mdl_ptr)
    call init_bc(mdl=mdl_ptr%p)
end subroutine f90wrap_call_model__init_bc

subroutine f90wrap_call_model__init_fortran(mdl)
...
end subroutine f90wrap_call_model__clean_model

subroutine f90wrap_call_model__output_gnu(mdl, dof, filename)
...
end subroutine f90wrap_call_model__output_vtk

subroutine f90wrap_call_model__output_tec(mdl, dof, filename)
...
end subroutine f90wrap_call_model__output_tec
...
end subroutine f90wrap_call_model__friction_initialise

subroutine f90wrap_call_model__friction_finalise(my_friction)
...
end subroutine f90wrap_call_model__friction_finalise

subroutine f90wrap_call_model__infiltration_initialise(my_infiltration, mesh)
...
end subroutine f90wrap_call_model__infiltration_initialise

subroutine f90wrap_call_model__infiltration_finalise(my_infiltration)
...
subroutine f90wrap_call_model__porosity_initialise(my_porosity, mesh)
    ...
    integer, intent(in), dimension(2) :: mesh
    mesh_ptr = transfer(mesh, mesh_ptr)
    allocate(my_porosity_ptr%p)
    call porosity_initialise(my_porosity=my_porosity_ptr%p, mesh=mesh_ptr%p)
    my_porosity = transfer(my_porosity_ptr, my_porosity)
...
subroutine f90wrap_call_model__porosity_finalise(my_porosity)
    ...
    type(porosity_data_ptr_type) :: my_porosity_ptr
    integer, intent(in), dimension(2) :: my_porosity
    my_porosity_ptr = transfer(my_porosity, my_porosity_ptr)
    call porosity_finalise(my_porosity=my_porosity_ptr%p)
    deallocate(my_porosity_ptr%p)
end subroutine f90wrap_call_model__porosity_finalise
...
end subroutine f90wrap_call_model__phys_desc_initialise

subroutine f90wrap_call_model__phys_desc_finalise(my_phys_desc)
...
end subroutine f90wrap_call_model__phys_desc_finalise

subroutine f90wrap_call_model__bc_initialise(my_bc, mesh)
    ...
    integer, intent(in), dimension(2) :: mesh
    mesh_ptr = transfer(mesh, mesh_ptr)
    allocate(my_bc_ptr%p)
    call bc_initialise(my_bc=my_bc_ptr%p, mesh=mesh_ptr%p)
    my_bc = transfer(my_bc_ptr, my_bc)
end subroutine f90wrap_call_model__bc_initialise

subroutine f90wrap_call_model__bc_finalise(my_bc)
    ...
    type(bcs_ptr_type) :: my_bc_ptr
    integer, intent(in), dimension(2) :: my_bc
    my_bc_ptr = transfer(my_bc, my_bc_ptr)
    call bc_finalise(my_bc=my_bc_ptr%p)
    deallocate(my_bc_ptr%p)
...
end subroutine f90wrap_call_model__func

subroutine f90wrap_call_model__write_land_uses
    use call_model, only: write_land_uses
    implicit none
    
    call write_land_uses()
end subroutine f90wrap_call_model__write_land_uses

subroutine f90wrap_call_model__write_bc
    use call_model, only: write_bc
    implicit none
    
    call write_bc()
end subroutine f90wrap_call_model__write_bc

subroutine f90wrap_call_model__write_hydrograph
...
subroutine f90wrap_call_model__dof_copy(i, o)
    ...
    o = transfer(o_ptr, o)
end subroutine f90wrap_call_model__dof_copy

subroutine f90wrap_call_model__mesh_copy(i, o)
    ...
    o = transfer(o_ptr, o)
end subroutine f90wrap_call_model__mesh_copy

subroutine f90wrap_call_model__reallocate_manning(new_size)
    use call_model, only: reallocate_manning
    implicit none
    
    integer, intent(in) :: new_size
    call reallocate_manning(new_size=new_size)
end subroutine f90wrap_call_model__reallocate_manning
