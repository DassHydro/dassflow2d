...
subroutine f90wrap_m_linear_algebra__vec2d_initialise(this)
    use m_linear_algebra, only: vec2d
    implicit none
...
end subroutine f90wrap_m_linear_algebra__vec2d_initialise

subroutine f90wrap_m_linear_algebra__vec2d_finalise(this)
    use m_linear_algebra, only: vec2d
    implicit none
...
end subroutine f90wrap_m_linear_algebra__vec2d_finalise
...
subroutine f90wrap_m_linear_algebra__vec3d_initialise(this)
    use m_linear_algebra, only: vec3d
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_linear_algebra__vec3d_initialise

subroutine f90wrap_m_linear_algebra__vec3d_finalise(this)
    use m_linear_algebra, only: vec3d
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_linear_algebra__vec3d_finalise
...
subroutine f90wrap_m_linear_algebra__tens2d_initialise(this)
    use m_linear_algebra, only: tens2d
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_linear_algebra__tens2d_initialise

subroutine f90wrap_m_linear_algebra__tens2d_finalise(this)
    use m_linear_algebra, only: tens2d
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_linear_algebra__tens2d_finalise
...
subroutine f90wrap_m_linear_algebra__tens3d_initialise(this)
    use m_linear_algebra, only: tens3d
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_linear_algebra__tens3d_initialise

subroutine f90wrap_m_linear_algebra__tens3d_finalise(this)
    use m_linear_algebra, only: tens3d
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_linear_algebra__tens3d_finalise
...
subroutine f90wrap_m_linear_algebra__sys_lin_full_initialise(this)
    use m_linear_algebra, only: sys_lin_full
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_linear_algebra__sys_lin_full_initialise

subroutine f90wrap_m_linear_algebra__sys_lin_full_finalise(this)
    use m_linear_algebra, only: sys_lin_full
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_linear_algebra__sys_lin_full_finalise
...
subroutine f90wrap_m_linear_algebra__sys_lin_sparse_initialise(this)
    use m_linear_algebra, only: sys_lin_sparse
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_linear_algebra__sys_lin_sparse_initialise

subroutine f90wrap_m_linear_algebra__sys_lin_sparse_finalise(this)
    use m_linear_algebra, only: sys_lin_sparse
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_linear_algebra__sys_lin_sparse_finalise
