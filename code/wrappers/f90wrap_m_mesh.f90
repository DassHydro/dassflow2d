...
subroutine f90wrap_m_mesh__nodetype_initialise(node, dim1, dim2)
    use m_mesh, only: nodetype, nodetype_initialise
    implicit none
...
end subroutine f90wrap_m_mesh__nodetype_initialise

subroutine f90wrap_m_mesh__nodetype_finalise(this)
    use m_mesh, only: nodetype
    implicit none
...
end subroutine f90wrap_m_mesh__nodetype_finalise
...
subroutine f90wrap_m_mesh__nodetypelim_initialise(nodelim, ind, group)
...
end subroutine f90wrap_m_mesh__nodetypelim_initialise

subroutine f90wrap_m_mesh__nodetypelim_finalise(this)
    use m_mesh, only: nodetypelim
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_mesh__nodetypelim_finalise

subroutine f90wrap_celltype__get__ind(this, f90wrap_ind)
    ...
    this_ptr = transfer(this, this_ptr)
    f90wrap_ind = this_ptr%p%ind
end subroutine f90wrap_celltype__get__ind

subroutine f90wrap_celltype__set__ind(this, f90wrap_ind)
    use m_mesh, only: celltype
    implicit none
    type celltype_ptr_type
        type(celltype), pointer :: p => NULL()
    ...
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%ind = f90wrap_ind
end subroutine f90wrap_celltype__set__ind
...
subroutine f90wrap_m_mesh__celltype_initialise(this)
    use m_mesh, only: celltype
    implicit none
...
end subroutine f90wrap_m_mesh__celltype_initialise

subroutine f90wrap_m_mesh__celltype_finalise(this)
    use m_mesh, only: celltype
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_mesh__celltype_finalise
...
subroutine f90wrap_m_mesh__celltypelim_initialise(this)
    use m_mesh, only: celltypelim
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_mesh__celltypelim_initialise

subroutine f90wrap_m_mesh__celltypelim_finalise(this)
    use m_mesh, only: celltypelim
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_mesh__celltypelim_finalise
...
subroutine f90wrap_m_mesh__edgetype_initialise(this)
    use m_mesh, only: edgetype
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_mesh__edgetype_initialise

subroutine f90wrap_m_mesh__edgetype_finalise(this)
    use m_mesh, only: edgetype
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_mesh__edgetype_finalise
...
subroutine f90wrap_m_mesh__edgetypelim_initialise(this)
    use m_mesh, only: edgetypelim
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_mesh__edgetypelim_initialise

subroutine f90wrap_m_mesh__edgetypelim_finalise(this)
    use m_mesh, only: edgetypelim
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_m_mesh__edgetypelim_finalise
...
subroutine f90wrap_msh__array_getitem__edgeb(f90wrap_this, f90wrap_i, edgebitem)
    ...
    use m_mesh, only: edgetypelim, msh
    implicit none
...
subroutine f90wrap_msh__array__swap_index(this, nd, dtype, dshape, dloc)
    use m_mesh, only: msh
    use, intrinsic :: iso_c_binding, only : c_int
    implicit none
    type msh_ptr_type
    ...
    dtype = 5
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%swap_index)) then
        dshape(1:1) = shape(this_ptr%p%swap_index)
        dloc = loc(this_ptr%p%swap_index)
    else
        dloc = 0
    end if
end subroutine f90wrap_msh__array__swap_index

subroutine f90wrap_msh__array__inv_swap_index(this, nd, dtype, dshape, dloc)
    use m_mesh, only: msh
    use, intrinsic :: iso_c_binding, only : c_int
    implicit none
    type msh_ptr_type
    ...
    dtype = 5
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%inv_swap_index)) then
        dshape(1:1) = shape(this_ptr%p%inv_swap_index)
        dloc = loc(this_ptr%p%inv_swap_index)
    else
        dloc = 0
    end if
end subroutine f90wrap_msh__array__inv_swap_index

subroutine f90wrap_m_mesh__msh_initialise(mesh)
    use m_mesh, only: msh_initialise, msh
    implicit none
...
end subroutine f90wrap_m_mesh__msh_finalise
...
subroutine f90wrap_m_mesh__point_in_mesh_initialise(this)
    use m_mesh, only: point_in_mesh
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_m_mesh__point_in_mesh_initialise

subroutine f90wrap_m_mesh__point_in_mesh_finalise(this)
    use m_mesh, only: point_in_mesh
    implicit none
...
end subroutine f90wrap_m_mesh__display_mesh_cell

subroutine f90wrap_m_mesh__calc_cells_connectivity(mesh)
...
end subroutine f90wrap_m_mesh__calc_cells_connectivity
