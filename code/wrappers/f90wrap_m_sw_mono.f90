...
subroutine f90wrap_xsshp_initialise(this)
    use m_model, only: xsshp
    implicit none
...
end subroutine f90wrap_xsshp_initialise

subroutine f90wrap_xsshp_finalise(this)
    use m_model, only: xsshp
    implicit none
...
end subroutine f90wrap_xsshp_finalise
...
subroutine f90wrap_porosity_data_initialise(this)
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_porosity_data_initialise

subroutine f90wrap_porosity_data_finalise(this)
    use m_model, only: porosity_data
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_porosity_data_finalise
...
subroutine f90wrap_gr4_initialise(this)
    use m_model, only: gr4
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_gr4_initialise

subroutine f90wrap_gr4_finalise(this)
    use m_model, only: gr4
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_gr4_finalise
...
subroutine f90wrap_station_obsq_initialise(this)
    use m_model, only: station_obsq
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_station_obsq_initialise

subroutine f90wrap_station_obsq_finalise(this)
    use m_model, only: station_obsq
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_station_obsq_finalise
...
subroutine f90wrap_ptf_data_initialise(this)
    use m_model, only: ptf_data
    implicit none
    ...
    allocate(this_ptr%p)
    this = transfer(this_ptr, this)
end subroutine f90wrap_ptf_data_initialise

subroutine f90wrap_ptf_data_finalise(this)
    use m_model, only: ptf_data
    implicit none
    ...
    this_ptr = transfer(this, this_ptr)
    deallocate(this_ptr%p)
end subroutine f90wrap_ptf_data_finalise
...
end subroutine f90wrap_spatial_index_fromxy
