...
subroutine f90wrap_init_mpi
    use m_mpi, only: init_mpi
    implicit none
    
    call init_mpi()
end subroutine f90wrap_init_mpi

subroutine f90wrap_end_mpi
    use m_mpi, only: end_mpi
    implicit none
    
    call end_mpi()
end subroutine f90wrap_end_mpi

subroutine f90wrap_fill_swap_lists(mesh)
...
end subroutine f90wrap_fill_swap_index

subroutine f90wrap_fill_inv_swap_index(mesh)
...
end subroutine f90wrap_com_var_r

subroutine f90wrap_mpi_send_recv_scal_i(to_send, to_recv, proc_send, proc_recv)
...
end subroutine f90wrap_mpi_send_recv_scal_i

subroutine f90wrap_mpi_send_recv_scal_r(to_send, to_recv, proc_send, proc_recv)
...
end subroutine f90wrap_mpi_send_recv_scal_r

subroutine f90wrap_mpi_send_recv_array_i(to_send, to_recv, proc_send, proc_recv, n0, n1)
...
end subroutine f90wrap_mpi_send_recv_array_i

subroutine f90wrap_mpi_send_recv_array_r(to_send, to_recv, proc_send, proc_recv, n0, n1)
...
end subroutine f90wrap_mpi_send_recv_array_r

subroutine f90wrap_mpi_sum_r(val)
    use m_mpi, only: mpi_sum_r
    implicit none
    
    real(8), intent(inout) :: val
    call mpi_sum_r(val=val)
end subroutine f90wrap_mpi_sum_r

subroutine f90wrap_mpi_sum_i(val)
    use m_mpi, only: mpi_sum_i
    implicit none
    
    integer(4), intent(inout) :: val
    call mpi_sum_i(val=val)
end subroutine f90wrap_mpi_sum_i

subroutine f90wrap_mpi_max_r(val)
    use m_mpi, only: mpi_max_r
    implicit none
    
    real(8), intent(inout) :: val
    call mpi_max_r(val=val)
end subroutine f90wrap_mpi_max_r

subroutine f90wrap_mpi_max_i(val)
    use m_mpi, only: mpi_max_i
    implicit none
    
    integer(4), intent(inout) :: val
    call mpi_max_i(val=val)
end subroutine f90wrap_mpi_max_i

subroutine f90wrap_mpi_min_r(val)
    use m_mpi, only: mpi_min_r
    implicit none
    
    real(8), intent(inout) :: val
    call mpi_min_r(val=val)
end subroutine f90wrap_mpi_min_r

subroutine f90wrap_mpi_min_i(val)
    use m_mpi, only: mpi_min_i
    implicit none
    
    integer(4), intent(inout) :: val
    call mpi_min_i(val=val)
end subroutine f90wrap_mpi_min_i

subroutine f90wrap_mpi_bcast_r(val, pr)
...
end subroutine f90wrap_mpi_bcast_r

subroutine f90wrap_mpi_bcast_i(val, pr)
...
end subroutine f90wrap_mpi_bcast_i

subroutine f90wrap_mpi_allgather_r(val, temp, n0)
...
end subroutine f90wrap_mpi_allgather_r

subroutine f90wrap_mpi_allgather_i(val, temp, n0)
...
end subroutine f90wrap_mpi_allgather_i

subroutine f90wrap_mpi_wait_all
    use m_mpi, only: mpi_wait_all
    implicit none
    
    call mpi_wait_all()
end subroutine f90wrap_mpi_wait_all

subroutine f90wrap_stopping_program_sub(comment)
    use m_mpi, only: stopping_program_sub
    implicit none
    
    character*(*), intent(in) :: comment
    call stopping_program_sub(comment=comment)
end subroutine f90wrap_stopping_program_sub
